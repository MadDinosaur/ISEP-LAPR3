CREATE OR REPLACE PROCEDURE containers_offloaded(pShipMmsi CARGOMANIFEST_PARTIAL.ship_mmsi%type, pPort CARGOMANIFEST_PARTIAL.storage_identification%type)
AS
...
call containers_offloaded(100000001, 2);